...
const Footer = () => <footer className="footer">
    <div>
            ...
            <div className="header">
                <p>introduce chanel in the world</p>
            </div>
            ...
            <div className="footer black">
                <ul>
                    ...
                    <li><a className="introduce" href="https://www.chanel.com/ru/about-chanel/the-history/">History</a></li>
                    <li><a className="introduce" href="https://www.chanel.com/ru/care-services/">Service</a></li>
                </ul>
            </div>
